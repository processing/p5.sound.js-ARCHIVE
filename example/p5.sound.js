/*! p5.sound.js v0.0.1 June 21, 2023 */
(function (f) {
...
*/
    ...
    141: [
      function (_dereq_, module, exports) {
        ...
        _dereq_('./sound/main');
        var _p5 = _interopRequireDefault(_dereq_('./sound/p5.Oscillator'));
        _dereq_('./sound/p5.SoundFile');
        ...
        _main.default.prototype.Oscillator = _p5.default;
      ...
      },
      {
        ...
        './core/main': 148,
        './core/p5.Element': 149,
        './core/p5.Renderer': 150,
        './core/p5.Renderer2D': 151,
        './core/preload': 152,
        './core/rendering': 153,
        ...
        './sound/main': 158,
        './sound/p5.Oscillator': 159,
        './sound/p5.SoundFile': 160,
        ...
        _main.default.prototype._setupPromisePreloads = function () {
          ...
          try {
            for (var _iterator = this._promisePreloads[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              var sourceFunction = target[method].bind(target); // If the target is the p5 prototype, then only set it up on the first run per page
