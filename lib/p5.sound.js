 ...
 */
   ...
   */
     ...
     */
      ...
      {
        './audioContext': 200,
        './audioWorklet/processorNames': 201,
        './helpers': 204,
        './main': 205,
...
*/
        ...
        function () {
          function CrossFade(initialFade) {
            ...
            this.output = _audioContext.default.createGain();
            this.a = this.input[0] = new _audioContext.default.createGain();
            this.b = this.input[1] = new _audioContext.default.createGain(); // connections
        ...
        var _default = CrossFade; // original source code
 ...
 */
    ...
    190: [
      function (_dereq_, module, exports) {
        ...
        var _default = Signal; // define(["Tone/core/Tone", "Tone/signal/WaveShaper", "Tone/type/Type", "Tone/core/Param", "Tone/core/Gain"], function(Tone){
        // 	"use strict";
        // 	/**
