 ...
 */
   ...
   */
     ...
     */
      ...
      {
        './audioContext': 201,
        './audioWorklet/processorNames': 202,
        './helpers': 205,
        './main': 206,
...
*/
    ...
    181: [
      function (_dereq_, module, exports) {
        ...
        var _Expr = _interopRequireDefault(_dereq_('./Expr'));
        var _EqualPowerGain = _interopRequireDefault(_dereq_('./EqualPowerGain'));
...
*/
    ...
    *  @type {EqualPowerGain}
    */
            this._equalPowerA = new _EqualPowerGain.default();
            /**
    *  equal power gain cross fade
    *  @private
    *  @type {Tone.EqualPowerGain}
    */
            this._equalPowerB = new _EqualPowerGain.default();
            /**
    *  invert the incoming signal
    *  @private
    *  @type {Tone}
    */
            this._invert = new _Expr.default('1 - $0'); //connections
   ...
   */
    ...
    185: [
      function (_dereq_, module, exports) {
        ...
        exports.default = void 0;
        var _WaveShaper = _interopRequireDefault(_dereq_('./WaveShaper'));
        function _interopRequireDefault(obj) {
          return obj && obj.__esModule ? obj : {
          default:
            obj
 ...
 */
        ...
        var EqualPowerGain =        /*#__PURE__*/
        function () {
          function EqualPowerGain() {
            _classCallCheck(this, EqualPowerGain);
            this._eqPower = this.input = this.output = new _WaveShaper.default(function (val) {
          ...
          return EqualPowerGain;
        }();
        var _default = EqualPowerGain;
        exports.default = _default;
      },
      {
        './WaveShaper': 199
    ...
    186: [
      function (_dereq_, module, exports) {
        ...
        } // https://raw.githubusercontent.com/Tonejs/Tone.js/r10/Tone/signal/Expr.js

        var Expr = function Expr() {
          _classCallCheck(this, Expr);
        };
        var _default = Expr; // define(["Tone/core/Tone", "Tone/signal/Add", "Tone/signal/Subtract", "Tone/signal/Multiply",
    ...
    */
    ...
    193: [
      function (_dereq_, module, exports) {
        ...
        exports.default = void 0;
        var _Signal = _interopRequireDefault(_dereq_('./Signal'));
        var _TimelineSignal = _interopRequireDefault(_dereq_('./TimelineSignal'));
        function _interopRequireDefault(obj) {
          return obj && obj.__esModule ? obj : {
          default:
            obj
          ...
          _createClass(SignalBase, [
            {
              ...
              value: function (_connect) {
                ...
                _TimelineSignal.default && _TimelineSignal.default === node.constructor) {
                  //cancel changes
    ...
    */
    ...
    200: [
      function (_dereq_, module, exports) {
        ...
        p5.prototype.EqualPowerGain = _EqualPowerGain.default;
        p5.prototype.Expr = _Expr.default;
        ...
        p5.prototype.TimeLineSignal = _TimelineSignal.default;
        p5.prototype.Type = _Type.default;
        p5.prototype.WaveShaper = _WaveShaper.default;
