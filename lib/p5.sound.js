/*! p5.sound.js v0.0.2-alpha August 23, 2023 */
(function (f) {
...
*/
        ...
        var SignalAudioToGain =        /*#__PURE__*/
        function () {
          /**
  *  @type {WaveShaperNode}
  *  @private
  */
          function SignalAudioToGain() {
  ...
  */
          ...
          _createClass(SignalAudioToGain, [
            {
              key: 'dispose',
              value: function (_dispose) {
                function dispose() {
          ...
          return SignalAudioToGain;
        }();
        var _default = SignalAudioToGain;
        exports.default = _default;
      },
      {
        'core-js/modules/es.object.to-string': 140,
...
*/
  ...
  * //mod outputs 0.1
  */
          function SignalModulo(modulus) {
            _classCallCheck(this, SignalModulo);
            /**
    * The modulus value.
    ...
    */
            this._shaper = new _SignalWaveShaper.default(Math.pow(2, 16));
            /**
    *  the integer multiple is multiplied by the modulus
    *  @type  {SignalMultiply}
    *  @private
    */
            this._multiply = new _SignalMultiply.default();
            /**
    *  and subtracted from the input signal
    *  @type  {SignalSubtract}
    *  @private
    */
            this._subtract = this.output = new _SignalSubtract.default();
            /**
    *  the modulus signal
    *  @type  {Signal}
    *  @private
    */
            this._modSignal = new Signal(modulus); //connections
    ...
    */
          ...
          _createClass(SignalModulo, [
            {
              key: '_setWaveShaper',
              value: function _setWaveShaper(mod) {
...
*/
  ...
  *  @private
  */
          function SignalNegate() {
            _classCallCheck(this, SignalNegate);
            this._multiply = this.input = this.output = new _SignalMultiply.default( - 1);
          }          /**
  *  clean up
  *  @returns {Tone.Negate} this
  */

          _createClass(SignalNegate, [
            {
              key: 'dispose',
              value: function (_dispose) {
                function dispose() {
...
*/
  ...
  */
    ...
    *  @private
    */
            this._expScaler = this.input = this.output = new _SignalWaveShaper.default(this._expFunc(this._exp), 8192);
          }          /**
    ...
    */
          ...
          _createClass(SignalPow, [
            {
              key: '_expFunc',
              value: function _expFunc(exp) {
                return function (val) {
...
*/
        ...
        var SignalScale =        /*#__PURE__*/
        function () {
          function SignalScale(outputMin, outputMax) {
    ...
    */
    ...
    // *  @private
    // */
            this._scale = this.input = new _SignalMultiply.default(1);
            /**
    *  @private
    *  @type {SignalAdd}
    *  @private
    */
            this._add = this.output = new _SignalAdd.default(0);
...
*/
        ...
        var SignalSubtract =        /*#__PURE__*/
        function () {
          function SignalSubtract(value) {
    ...
    *  @private
    */
            this._sum = this.input[0] = this.output = new _Gain.default();
            /**
    ...
    *  @private
    */
            this._neg = new _SignalNegate.default();
            /**
    *  the node where the value is set
    *  @private
    *  @type {Tone.Signal}
  ...
  // */
          ...
          return SignalSubtract;
        }();
        var _default = SignalSubtract;
        exports.default = _default;
      },
      {
        './Gain': 191,
    ...
    208: [
      function (_dereq_, module, exports) {
        ...
        var SignalTimeLineSignal = function SignalTimeLineSignal() {
          _classCallCheck(this, SignalTimeLineSignal);
        };
        var _default = SignalTimeLineSignal; // define(['Tone/core/Tone', 'Tone/signal/Signal', 'Tone/core/Timeline'], function (Tone) {
        //   /**
    ...
    209: [
      function (_dereq_, module, exports) {
        ...
        var SignalWaveShaper =        /*#__PURE__*/
        function () {
          function SignalWaveShaper(mapping, bufferLen) {
            _classCallCheck(this, SignalWaveShaper);
    ...
    */
          ...
          return SignalWaveShaper;
        }();
        var _default = SignalWaveShaper; // original code
