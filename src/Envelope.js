...
import { TransportTimelineSignal as ToneTransportTimelineSignal } from 'tone';
...
class Envelope {
  constructor(t1, l1, t2, l2, t3, l3) {
    ...
    this.control = new ToneTransportTimelineSignal();
  ...
  connect(unit) {
    ...
    if (
      ...
      unit instanceof SoundFile ||
      unit instanceof AudioIn ||
      unit instanceof Reverb ||
      unit instanceof Noise ||
      unit instanceof BiquadFilter ||
      unit instanceof Delay
    ) {
  ...
  add(num) {
    ...
    return p5.prototype._mathChain(this, add, thisChain, nextChain, ToneAdd);
  }
  ...
  mult(num) {
    ...
    return p5.prototype._mathChain(
      this, mult, thisChain, nextChain, ToneMultiply);
  }
  ...
  scale(inMin, inMax, outMin, outMax) {
    ...
    let nextChain = this.output;
    return p5.prototype._mathChain(
      this, scale, thisChain, nextChain, ToneScale);
  }
