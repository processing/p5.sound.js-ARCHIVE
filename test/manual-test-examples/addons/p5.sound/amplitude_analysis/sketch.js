// /**
//  * DEMO:  Use p5sound.Amplitude (volume) to change the size of an ellipse
//  */
...
//   // create a new p5sound.Amplitude. Optionally, give it a 'smoothing' value betw 0.0 and .999
//   amplitude = new p5sound.Amplitude(smoothing);
