...
//   env = new p5sound.Env(0.01, 0.8, 0.2, 0);
//   osc = new p5sound.TriOsc(); // connects to main output by default
//   osc.start(0);
//   osc.connect();
//   env.setInput(osc);

//   // prepare the noise and env used by playSnare()
//   noise = new p5sound.Noise();
//   // noise.amp(0.0);
//   noise.start();
//   noiseEnv = new p5sound.Env(0.01, 0.5, 0.1, 0);
//   noiseEnv.setInput(noise);
//   // create a part with 8 spaces, where each space represents 1/16th note (default)
//   part = new p5sound.Part(8, 1 / 16);
