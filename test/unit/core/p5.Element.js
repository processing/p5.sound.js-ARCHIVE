// suite('p5sound.Element', function() {
//   var myp5sound = new p5sound(function(sketch) {
...
//   suite('p5sound.Element.prototype.parent', function() {
//     test('attaches child to parent', function() {
//       let div0 = myp5sound.createDiv('this is the parent');
//       let div1 = myp5sound.createDiv('this is the child');
...
//       assert.equal(myp5sound.select('#child').parent(), div0);
//     });
//   });

//   suite('p5sound.Element.prototype.id', function() {
//     test('attaches child to parent', function() {
//       elt = myp5sound.createDiv();
//       elt.id('test');
...
//       assert.equal(myp5sound.select('#child').id(), 'child');
//     });
//   });
...
//       myp5sound.select('#testdiv').addClass('testclass');
...
//       myp5sound.select('#testdiv').removeClass('testclass');
...
//       myp5sound.select('#testdiv').removeClass('testclass2');
...
//       assert.strictEqual(myp5sound.select('#testdiv').hasClass('testclass2'), true);
//     });
...
//       assert.strictEqual(myp5sound.select('#testdiv').hasClass('testclass2'), false);
//     });
...
//       assert.strictEqual(myp5sound.select('#testdiv').hasClass('show'), false);
//       assert.strictEqual(myp5sound.select('#testdiv').hasClass('slide'), false);
//       assert.strictEqual(myp5sound.select('#testdiv').hasClass('test'), false);
//       assert.strictEqual(myp5sound.select('#testdiv').hasClass('class'), false);
//     });
...
//       myp5sound.select('#testdiv').toggleClass('testclass2');
