...
//   suite('p5sound.prototype.setHeading() RADIANS', function() {
//     setup(function() {
//       myp5sound.angleMode(RADIANS);
//       v = myp5sound.createVector(1, 1);
//       v.setHeading(1);
//     });
...
//   suite('p5sound.prototype.setHeading() DEGREES', function() {
//     setup(function() {
...
//   suite('p5sound.prototype.createVector()', function() {
//     setup(function() {
//       v = myp5sound.createVector();
//     });
//     test('should create instance of p5sound.Vector', function() {
//       assert.instanceOf(v, p5sound.Vector);
//     });
...
//   suite('p5sound.prototype.createVector(1, 2, 3)', function() {
//     setup(function() {
//       v = myp5sound.createVector(1, 2, 3);
//     });
...
//   suite('new p5sound.Vector()', function() {
//     setup(function() {
//       v = new p5sound.Vector();
//     });
...
//   suite('new p5sound.Vector(1, 2, 3)', function() {
//     setup(function() {
//       v = new p5sound.Vector(1, 2, 3);
//     });
...
//   suite('new p5sound.Vector(1,2,undefined)', function() {
//     setup(function() {
//       v = new p5sound.Vector(1, 2, undefined);
//     });
...
//     suite('p5sound.Vector.prototype.rotate() [INSTANCE]', function() {
//       test('should return the same object', function() {
//         v = myp5sound.createVector(0, 1);
...
//           v = myp5sound.createVector(0, 1, 0);
//           v.rotate(Math.PI);
...
//           v = myp5sound.createVector(1, 0, 0);
//           v.rotate(-Math.PI / 2);
//           expect(v.x).to.be.closeTo(0, 0.01);
//           expect(v.y).to.be.closeTo(-1, 0.01);
//           expect(v.z).to.be.closeTo(0, 0.01);
...
//     suite('p5sound.Vector.rotate() [CLASS]', function() {
//       setup(function() {
//         myp5sound.angleMode(RADIANS);
//       });
...
//         v = myp5sound.createVector(1, 0, 0);
//         p5sound.Vector.rotate(v, Math.PI / 2);
...
//       test('should rotate the vector [0, 1, 0] by pi radians to [0, -1, 0]', function() {
//         v = myp5sound.createVector(0, 1, 0);
//         const v1 = p5sound.Vector.rotate(v, Math.PI);
...
//       test('should rotate the vector [1, 0, 0] by -pi/2 radians to [0, -1, 0]', function() {
//         v = myp5sound.createVector(1, 0, 0);
//         const v1 = p5sound.Vector.rotate(v, -Math.PI / 2);
//         expect(v1.x).to.be.closeTo(0, 0.01);
//         expect(v1.y).to.be.closeTo(-1, 0.01);
//         expect(v1.z).to.be.closeTo(0, 0.01);
//       });
...
//     let v1, v2;
//     setup(function() {
//       v1 = new p5sound.Vector(1, 0, 0);
//       v2 = new p5sound.Vector(2, 2, 0);
//     });

//     suite('p5sound.Vector.prototype.angleBetween() [INSTANCE]', function() {
...
//         v1 = new p5sound.Vector(-11, -20);
//         v2 = new p5sound.Vector(-5.5, -10);
//         const v3 = new p5sound.Vector(5.5, 10);
...
//         v1 = new p5sound.Vector(1, 1.1, 1.2);
//         v2 = new p5sound.Vector(2, 2.2, 2.4);
//         expect(v1.angleBetween(v2)).to.be.closeTo(0, 0.00001);
//       });

//       test('should return NaN for zero vector', function() {
//         v1 = new p5sound.Vector(0, 0, 0);
//         v2 = new p5sound.Vector(2, 3, 4);
...
//         myp5sound.angleMode(DEGREES);
//         v1 = myp5sound.createVector(1, 0, 0);
//         v2 = myp5sound.createVector(1, 0, 0);
//         expect(v1.angleBetween(v2)).to.equal(0);
//       });

//       test('between [0,3,0] and [0,-3,0] should be 180 degrees', function() {
//         myp5sound.angleMode(DEGREES);
//         v1 = myp5sound.createVector(0, 3, 0);
//         v2 = myp5sound.createVector(0, -3, 0);
...
//         v1 = new p5sound.Vector(2, 0, 0);
//         v2 = new p5sound.Vector(-2, 0, 0);
...
//         v1 = myp5sound.createVector(288, 814);
//         v2 = myp5sound.createVector(288, 814);
//         expect(v1.angleBetween(v2)).to.equal(0);
//       });

//       test('The angle between vectors pointing in opposite is always PI.', function() {
//         v1 = myp5sound.createVector(219, 560);
//         v2 = myp5sound.createVector(-219, -560);
//         expect(v1.angleBetween(v2)).to.be.closeTo(Math.PI, 0.0000001);
//       });
//     });

//     suite('p5sound.Vector.angleBetween() [CLASS]', function() {
//       test('should return NaN for zero vector', function() {
//         v1 = new p5sound.Vector(0, 0, 0);
//         v2 = new p5sound.Vector(2, 3, 4);
//         expect(p5sound.Vector.angleBetween(v1, v2)).to.be.NaN;
//         expect(p5sound.Vector.angleBetween(v2, v1)).to.be.NaN;
//       });

//       test('between [1,0,0] and [0,-1,0] should be -90 degrees', function() {
//         myp5sound.angleMode(DEGREES);
//         v1 = myp5sound.createVector(1, 0, 0);
//         v2 = myp5sound.createVector(0, -1, 0);
//         expect(p5sound.Vector.angleBetween(v1, v2)).to.be.closeTo(-90, 0.01);
//       });

//       test('between [0,3,0] and [0,-3,0] should be PI radians', function() {
//         v1 = new p5sound.Vector(0, 3, 0);
//         v2 = new p5sound.Vector(0, -3, 0);
//         expect(p5sound.Vector.angleBetween(v1, v2)).to.be.closeTo(Math.PI, 0.01);
//       });
//     });
//   });

//   suite('set()', function() {
//     suite('with p5sound.Vector', function() {
//       test("should have x, y, z be initialized to the vector's x, y, z", function() {
//         v.set(new p5sound.Vector(2, 5, 6));
//         expect(v.x).to.eql(2);
//         expect(v.y).to.eql(5);
//         expect(v.z).to.eql(6);
//       });
...
//   suite('copy', function() {
//     setup(function() {
//       v = new p5sound.Vector(2, 3, 4);
//     });

//     suite('p5sound.Vector.prototype.copy() [INSTANCE]', function() {
...
//     suite('p5sound.Vector.copy() [CLASS]', function() {
//       test('should not return the same instance', function() {
//         var newObject = p5sound.Vector.copy(v);
//         expect(newObject).to.not.equal(v);
//       });
...
//         v.add(new p5sound.Vector(1, 5, 6));
//         expect(v.x).to.eql(1);
//         expect(v.y).to.eql(5);
//         expect(v.z).to.eql(6);
//       });
...
//     suite('p5sound.Vector.add(v1, v2)', function() {
//       var v1, v2, res;
//       setup(function() {
//         v1 = new p5sound.Vector(2, 0, 3);
//         v2 = new p5sound.Vector(0, 1, 3);
//         res = p5sound.Vector.add(v1, v2);
//       });
...
//       test('should be sum of the two p5sound.Vectors', function() {
...
//   suite('rem()', function() {
//     setup(function() {
//       v = myp5sound.createVector(3, 4, 5);
//     });
...
//         v.rem(new p5sound.Vector(0, 0, 4));
//         expect(v.x).to.eql(3);
//         expect(v.y).to.eql(4);
//         expect(v.z).to.eql(1);
//       });
...
//         v.rem(new p5sound.Vector(0, 3, 4));
//         expect(v.x).to.eql(3);
//         expect(v.y).to.eql(1);
//         expect(v.z).to.eql(1);
//       });
...
//         v.rem(new p5sound.Vector(2, 3, 4));
//         expect(v.x).to.eql(1);
//         expect(v.y).to.eql(1);
//         expect(v.z).to.eql(1);
//       });
...
//         v.rem(new p5sound.Vector(0, 0, 0));
//         expect(v.x).to.eql(3);
//         expect(v.y).to.eql(4);
//         expect(v.z).to.eql(5);
//       });
...
//       let v;
//       setup(function() {
//         v = new p5sound.Vector(-15, -5, -2);
//       });
//       test('should return correct output', () => {
//         v.rem(new p5sound.Vector(2, 3, 3));
//         expect(v.x).to.eql(-1);
//         expect(v.y).to.eql(-2);
//         expect(v.z).to.eql(-2);
//       });
...
//     suite('p5sound.Vector.rem(v1,v2)', function() {
//       let v1, v2, res;
//       setup(function() {
//         v1 = new p5sound.Vector(2, 3, 4);
//         v2 = new p5sound.Vector(1, 2, 3);
//         res = p5sound.Vector.rem(v1, v2);
//       });
...
//         v.sub(new p5sound.Vector(2, 5, 6));
//         expect(v.x).to.eql(-2);
//         expect(v.y).to.eql(-5);
//         expect(v.z).to.eql(-6);
//       });
...
//     suite('p5sound.Vector.sub(v1, v2)', function() {
//       var v1, v2, res;
//       setup(function() {
//         v1 = new p5sound.Vector(2, 0, 3);
//         v2 = new p5sound.Vector(0, 1, 3);
//         res = p5sound.Vector.sub(v1, v2);
//       });
...
//     suite('p5sound.Vector.mult(v, n)', function() {
//       var v, res;
//       setup(function() {
//         v = new p5sound.Vector(1, 2, 3);
//         res = p5sound.Vector.mult(v, 4);
//       });

//       test('should return a new p5sound.Vector', function() {
...
//     suite('p5sound.Vector.mult(v, v', function() {
//       var v0, v1, res;
//       setup(function() {
//         v0 = new p5sound.Vector(1, 2, 3);
//         v1 = new p5sound.Vector(2, 3, 4);
//         res = p5sound.Vector.mult(v0, v1);
//       });
...
//     suite('p5sound.Vector.mult(v, arr', function() {
//       var v0, arr, res;
//       setup(function() {
//         v0 = new p5sound.Vector(1, 2, 3);
//         arr = [2, 3, 4];
//         res = p5sound.Vector.mult(v0, arr);
//       });
...
//     suite('p5sound.Vector.div(v, n)', function() {
//       var v, res;
//       setup(function() {
//         v = new p5sound.Vector(1, 1, 1);
//         res = p5sound.Vector.div(v, 4);
//       });
...
//       var v0, v1, v2, v3;
//       setup(function() {
//         v0 = new p5sound.Vector(2, 6, 9);
//         v1 = new p5sound.Vector(2, 2, 3);
//         v2 = new p5sound.Vector(1, 1, 1);
//         v3 = new p5sound.Vector(0, 0, 0);
...
//         const v = new p5sound.Vector(1, 1);
//         const divisor = new p5sound.Vector(2, 2);
//         v.div(divisor);
...
//         const v = new p5sound.Vector(1, 0);
//         const divisor = new p5sound.Vector(2, 2);
//         v.div(divisor);
//         expect(v.x).to.eql(0.5);
//         expect(v.y).to.eql(0);
...
//         const v = new p5sound.Vector(1, 1);
//         const divisor = new p5sound.Vector(0, 2);
//         v.div(divisor);
//         expect(v.x).to.eql(1);
//         expect(v.y).to.eql(1);
//         expect(v.z).to.eql(0);
...
//     suite('p5sound.Vector.div(v, v', function() {
//       var v0, v1, res;
//       setup(function() {
//         v0 = new p5sound.Vector(2, 6, 9);
//         v1 = new p5sound.Vector(2, 2, 3);
//         res = p5sound.Vector.div(v0, v1);
//       });
...
//     suite('p5sound.Vector.div(v, arr', function() {
//       var v0, arr, res;
//       setup(function() {
//         v0 = new p5sound.Vector(2, 6, 9);
//         arr = [2, 2, 3];
//         res = p5sound.Vector.div(v0, arr);
//       });
...
//     test('should return a number', function() {
//       expect(typeof v.dot(new p5sound.Vector()) === 'number').to.eql(true);
//     });

//     suite('with p5sound.Vector', function() {
//       test('should be the dot product of the vector', function() {
//         expect(v.dot(new p5sound.Vector(2, 2))).to.eql(4);
//       });
//     });
...
//     suite('p5sound.Vector.dot(v, n)', function() {
//       var v1, v2, res;
//       setup(function() {
//         v1 = new p5sound.Vector(1, 1, 1);
//         v2 = new p5sound.Vector(2, 3, 4);
//         res = p5sound.Vector.dot(v1, v2);
//       });
...
//       expect(v.cross(new p5sound.Vector())).to.not.eql(v);
//     });

//     suite('with p5sound.Vector', function() {
//       test('should cross x, y, z  from the vector argument', function() {
//         res = v.cross(new p5sound.Vector(2, 5, 6));
...
//     suite('p5sound.Vector.cross(v1, v2)', function() {
//       var v1, v2, res;
//       setup(function() {
//         v1 = new p5sound.Vector(3, 6, 9);
//         v2 = new p5sound.Vector(1, 1, 1);
//         res = p5sound.Vector.cross(v1, v2);
//       });
...
//       v.y = 0;
//       v.z = 1;
//       b = new p5sound.Vector(0, 0, 5);
//       c = new p5sound.Vector(3, 4, 1);
//     });
...
//   suite('p5sound.Vector.dist(v1, v2)', function() {
//     var v1, v2;
//     setup(function() {
//       v1 = new p5sound.Vector(0, 0, 0);
//       v2 = new p5sound.Vector(0, 3, 4);
//     });

//     test('should return a number', function() {
//       expect(typeof p5sound.Vector.dist(v1, v2) === 'number').to.eql(true);
//     });

//     test('should be commutative', function() {
//       expect(p5sound.Vector.dist(v1, v2)).to.eql(p5sound.Vector.dist(v2, v1));
//     });
//   });

//   suite('normalize', function() {
//     suite('p5sound.Vector.prototype.normalize() [INSTANCE]', function() {
//       setup(function() {
//         v = myp5sound.createVector(1, 1, 1);
//       });
...
//     suite('p5sound.Vector.normalize(v) [CLASS]', function() {
//       var res;
//       setup(function() {
//         v = myp5sound.createVector(1, 0, 0);
//         res = p5sound.Vector.normalize(v);
//       });
...
//     setup(function() {
//       v = new p5sound.Vector(5, 5, 5);
//     });

//     suite('p5sound.Vector.prototype.limit() [INSTANCE]', function() {
//       test('should return the same object', function() {
...
//     suite('p5sound.Vector.limit() [CLASS]', function() {
//       test('should not return the same object', function() {
//         expect(p5sound.Vector.limit(v)).to.not.equal(v);
//       });

//       suite('with a vector larger than the limit', function() {
//         test('should limit the vector', function() {
//           const res = p5sound.Vector.limit(v, 1);
...
//       suite('with a vector smaller than the limit', function() {
//         test('should not limit the vector', function() {
//           const res = p5sound.Vector.limit(v, 8.67);
...
//           const target = new p5sound.Vector(0, 0, 0);
//           p5sound.Vector.limit(v, 1, target);
...
//     setup(function() {
//       v = new p5sound.Vector(1, 0, 0);
//     });

//     suite('p5sound.Vector.setMag() [INSTANCE]', function() {
//       test('should return the same object', function() {
...
//     suite('p5sound.Vector.prototype.setMag() [CLASS]', function() {
//       test('should not return the same object', function() {
//         expect(p5sound.Vector.setMag(v, 2)).to.not.equal(v);
//       });

//       test('should set the magnitude of the vector', function() {
//         const res = p5sound.Vector.setMag(v, 4);
//         expect(res.x).to.eql(4);
//         expect(res.y).to.eql(0);
//         expect(res.z).to.eql(0);
//       });
...
//         v.y = 3;
//         v.z = -6;
//         const res = p5sound.Vector.setMag(v, 14);
//         expect(res.x).to.eql(4);
//         expect(res.y).to.eql(6);
//         expect(res.z).to.eql(-12);
//       });
...
//           const target = new p5sound.Vector(0, 1, 0);
//           const res = p5sound.Vector.setMag(v, 4, target);
...
//     suite('p5sound.Vector.prototype.heading() [INSTANCE]', function() {
//       test('should return a number', function() {
...
//     suite('p5sound.Vector.heading() [CLASS]', function() {
//       test('should return a number', function() {
//         expect(typeof p5sound.Vector.heading(v) === 'number').to.eql(true);
//       });
...
//         v.y = 0;
//         v.z = 0;
//         expect(p5sound.Vector.heading(v)).to.be.closeTo(0, 0.01);
//       });
...
//         v.y = 1;
//         v.z = 0;
//         expect(p5sound.Vector.heading(v)).to.be.closeTo(Math.PI / 2, 0.01);
//       });
...
//         v.y = 0;
//         v.z = 0;
//         expect(p5sound.Vector.heading(v)).to.be.closeTo(Math.PI, 0.01);
//       });
//     });
//   });
...
//     //     v.lerp(new p5sound.Vector(1,2,3), 1);
...
//   suite('p5sound.Vector.lerp(v1, v2, amt)', function() {
//     var res, v1, v2;
//     setup(function() {
//       v1 = new p5sound.Vector(0, 0, 0);
//       v2 = new p5sound.Vector(2, 2, 2);
//       res = p5sound.Vector.lerp(v1, v2, 0.5);
//     });
...
//     test('should be a p5sound.Vector', function() {
//       expect(res).to.be.an.instanceof(p5sound.Vector);
//     });
...
//   suite('p5sound.Vector.fromAngle(angle)', function() {
//     var res, angle;
//     setup(function() {
//       angle = Math.PI / 2;
//       res = p5sound.Vector.fromAngle(angle);
//     });

//     test('should be a p5sound.Vector with values (0,1)', function() {
//       expect(res.x).to.be.closeTo(0, 0.01);
//       expect(res.y).to.be.closeTo(1, 0.01);
//     });
//   });

//   suite('p5sound.Vector.random2D()', function() {
//     var res;
//     setup(function() {
//       res = p5sound.Vector.random2D();
//     });

//     test('should be a unit p5sound.Vector', function() {
//       expect(res.mag()).to.be.closeTo(1, 0.01);
//     });
//   });

//   suite('p5sound.Vector.random3D()', function() {
//     var res;
//     setup(function() {
//       res = p5sound.Vector.random3D();
//     });
//     test('should be a unit p5sound.Vector', function() {
//       expect(res.mag()).to.be.closeTo(1, 0.01);
//     });
...
//     setup(function() {
//       v = new p5sound.Vector(1, 23, 4);
//     });

//     suite('p5sound.Vector.prototype.array() [INSTANCE]', function() {
...
//     suite('p5sound.Vector.array() [CLASS]', function() {
//       test('should return an array', function() {
//         expect(p5sound.Vector.array(v)).to.be.instanceof(Array);
//       });

//       test('should return an with the x y and z components', function() {
//         expect(p5sound.Vector.array(v)).to.eql([1, 23, 4]);
//       });
//     });
//   });

//   suite('reflect', function() {
//     suite('p5sound.Vector.prototype.reflect() [INSTANCE]', function() {
//       setup(function() {
//         incoming_x = 1;
//         incoming_y = 1;
//         incoming_z = 1;
//         original_incoming = new p5sound.Vector(incoming_x, incoming_y, incoming_z);

//         x_normal = new p5sound.Vector(3, 0, 0);
//         y_normal = new p5sound.Vector(0, 3, 0);
//         z_normal = new p5sound.Vector(0, 0, 3);

//         x_bounce_incoming = new p5sound.Vector(incoming_x, incoming_y, incoming_z);
//         x_bounce_outgoing = x_bounce_incoming.reflect(x_normal);

//         y_bounce_incoming = new p5sound.Vector(incoming_x, incoming_y, incoming_z);
//         y_bounce_outgoing = y_bounce_incoming.reflect(y_normal);

//         z_bounce_incoming = new p5sound.Vector(incoming_x, incoming_y, incoming_z);
//         z_bounce_outgoing = z_bounce_incoming.reflect(z_normal);
//       });

//       test('should return a p5sound.Vector', function() {
//         expect(x_bounce_incoming).to.be.an.instanceof(p5sound.Vector);
//         expect(y_bounce_incoming).to.be.an.instanceof(p5sound.Vector);
//         expect(z_bounce_incoming).to.be.an.instanceof(p5sound.Vector);
//       });
...
//     suite('p5sound.Vector.reflect() [CLASS]', function() {
//       setup(function() {
//         incoming_x = 1;
//         incoming_y = 1;
//         incoming_z = 1;
//         original_incoming = new p5sound.Vector(incoming_x, incoming_y, incoming_z);
//         x_target = new p5sound.Vector();
//         y_target = new p5sound.Vector();
//         z_target = new p5sound.Vector();
...
//         x_bounce_incoming = new p5sound.Vector(incoming_x, incoming_y, incoming_z);
//         x_bounce_outgoing = p5sound.Vector.reflect(
//           x_bounce_incoming,
//           x_normal,
//           x_target
//         );
...
//         y_bounce_incoming = new p5sound.Vector(incoming_x, incoming_y, incoming_z);
//         y_bounce_outgoing = p5sound.Vector.reflect(
//           y_bounce_incoming,
//           y_normal,
//           y_target
//         );
...
//         z_bounce_incoming = new p5sound.Vector(incoming_x, incoming_y, incoming_z);
//         z_bounce_outgoing = p5sound.Vector.reflect(
//           z_bounce_incoming,
//           z_normal,
//           z_target
//         );
...
//     setup(function() {
//       v0 = new p5sound.Vector(0, 0, 0);
//       v1 = new p5sound.Vector(1, 2, 3);
//     });

//     suite('p5sound.Vector.prototype.mag() [INSTANCE]', function() {
...
//     suite('p5sound.Vector.mag() [CLASS]', function() {
//       test('should return the magnitude of the vector', function() {
//         expect(p5sound.Vector.mag(v0)).to.eql(0);
//         expect(p5sound.Vector.mag(v1)).to.eql(MAG);
//       });
//     });
//   });
...
//     suite('p5sound.Vector.prototype.magSq() [INSTANCE]', function() {
//       test('should return the magnitude of the vector', function() {
...
//     suite('p5sound.Vector.magSq() [CLASS]', function() {
//       test('should return the magnitude of the vector', function() {
//         expect(p5sound.Vector.magSq(v0)).to.eql(0);
//         expect(p5sound.Vector.magSq(v1)).to.eql(MAG);
//       });
//     });
//   });

//   suite('equals', function() {
//     suite('p5sound.Vector.prototype.equals() [INSTANCE]', function() {
//       test('should return false for parameters inequal to the vector', function() {
//         const v1 = new p5sound.Vector(0, -1, 1);
//         const v2 = new p5sound.Vector(1, 2, 3);
//         const a2 = [1, 2, 3];
...
//         const v1 = new p5sound.Vector(0, -1, 1);
//         const v2 = new p5sound.Vector(0, -1, 1);
...
//     suite('p5sound.Vector.equals() [CLASS]', function() {
//       test('should return false for inequal parameters', function() {
//         const v1 = new p5sound.Vector(0, -1, 1);
//         const v2 = new p5sound.Vector(1, 2, 3);
//         const a2 = [1, 2, 3];
//         expect(p5sound.Vector.equals(v1, v2)).to.be.false;
//         expect(p5sound.Vector.equals(v1, a2)).to.be.false;
//         expect(p5sound.Vector.equals(a2, v1)).to.be.false;
//       });

//       test('should return true for equal vectors', function() {
//         const v1 = new p5sound.Vector(0, -1, 1);
//         const v2 = new p5sound.Vector(0, -1, 1);
//         expect(p5sound.Vector.equals(v1, v2)).to.be.true;
//       });

//       test('should return true for equal vectors and arrays', function() {
//         const v1 = new p5sound.Vector(0, -1, 1);
//         const a1 = [0, -1, 1];
//         expect(p5sound.Vector.equals(v1, a1)).to.be.true;
//         expect(p5sound.Vector.equals(a1, v1)).to.be.true;
//       });

//       test('should return true for equal arrays', function() {
//         const a1 = [0, -1, 1];
//         const a2 = [0, -1, 1];
//         expect(p5sound.Vector.equals(a1, a2)).to.be.true;
//       });
//     });
//   });
// });
